...
데이터 통합 솔루션을 **제안·설계**하기 위한 프레젠테이션, 솔루션상세, 설계 문서 웹 앱입니다.
...
| 구분 | 내용 |
|------|------|
| **서비스 목적** | 분산 IoT 데이터 통합, TCP·MQTT·REST 등 다채널 수집, **실시간 모니터링·원격 제어·분석**으로 무중단 서비스를 지원하는 **데이터 통합 솔루션** |
...
- **3000 (Vite)**: 프레젠테이션·솔루션상세·설계 문서 → **배포·메인 사용**
...
| **솔루션상세** | `/#solution` | 7개 프레임 (문제정의·표준화·통합·모니터링·제어·분석·확장) |
